<?php $data["title"] = "1.1 Tra cứu con người - chưa có GCN"; ?>
<?php $body = '' ?>
<?php $home = false; ?>
...
<div class="uk-section-small cocauquantri__section2">
    <div class="uk-container">
        ...
        <div class="uk-text-center tracuu__boxTop46 uk-text-center">
            <div class="item__24">
                <img src="images/tracuu/not-gcn.png" alt="">
            </div>
            <div class="item__24">
                <div class="tracuu__txt1">Không tìm thấy giấy chứng nhận điện tử</div>
            </div>
        </div>
    </div>
</div>
